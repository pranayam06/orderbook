...
// info about one particular bid or ask 
...
// a bunch of those infos (a series of bids or asks)

using LevelInfos = std::vector<LevelInfo>;  


// all the info of the order book
...
// using a list lets us iterate and have order of the bids/ask
